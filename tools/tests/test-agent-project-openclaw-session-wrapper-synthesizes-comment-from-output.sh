...
session="fl-issue-openclaw-synth-comment"
...
grep -q '^Synthesized comment body$' "$run_dir/issue-comment.md"

echo "agent-project openclaw session wrapper synthesizes comment from output test passed"
