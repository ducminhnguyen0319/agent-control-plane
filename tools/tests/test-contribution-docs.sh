...
grep -q 'They do not transfer ownership, copyright, patent rights, or control over the' "$ROOT_DIR/README.md"
grep -q 'Contributors are not automatically entitled to sponsorship payouts\.' "$ROOT_DIR/README.md"
